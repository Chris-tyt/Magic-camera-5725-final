...
#                         model_complexity=0, enable_segmentation=False) as holistic:
#     while RUNNING:
...
#             fps_text = font.render(f"FPS: {fps:.2f}", True, BLACK)  # White text
#             screen.blit(fps_text, (10, 10))  # Position at the top right (10 pixels from top left)
...
screen_size = (320, 240)
screen = pygame.display.set_mode(screen_size)
pygame.display.set_caption('Face and Hand Detection')
screen.fill((0, 0, 0))
pygame.display.update()
...
with mp_face_mesh.FaceMesh(min_detection_confidence=0.5, min_tracking_confidence=0.5) as face_mesh, \
    ...
    while RUNNING:
        ...
        # Process frame with FaceMesh and Hands
